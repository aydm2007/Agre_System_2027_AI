...
- generated_at: `2026-03-24T00:33:26.154666-07:00`
- overall_status: `FAIL`
- suite_dir: `C:\tools\workspace\AgriAsset_v44\docs\evidence\closure\20260323_235518\verify_axis_complete_v21`
...
| `axis_static` | `Restore drill evidence contract` | `PASS` | `0` |
| `axis_static` | `Fiscal period gate contract` | `FAIL` | `1` |
...
| `axis_frontend` | `Axis Playwright supplier settlement proof` | `FAIL` | `1` |
| `axis_frontend` | `Axis Playwright contract operations proof` | `FAIL` | `1` |
| `axis_frontend` | `Axis Playwright fixed-assets proof` | `FAIL` | `1` |
| `axis_frontend` | `Axis Playwright fuel and dual-mode proof` | `FAIL` | `1` |
