...
- generated_at: `2026-03-23T10:34:35.601306-07:00`
- overall_status: `FAIL`
- suite_dir: `C:\tools\workspace\AgriAsset_v44\docs\evidence\closure\20260323_102154\verify_release_gate_v21`
- latest_dir: `C:\tools\workspace\AgriAsset_v44\docs\evidence\closure\latest\verify_release_gate_v21`
...
| `static` | `Decimal mutation guard` | `FAIL` | `1` |
...
| `frontend` | `Frontend lint` | `BLOCKED` | `127` |
| `frontend` | `Frontend focused Vitest suites` | `BLOCKED` | `127` |
| `frontend` | `Frontend build` | `BLOCKED` | `127` |
...
| `frontend` | `Frontend lint` | `BLOCKED` | `127` |
| `frontend` | `Frontend test CI` | `BLOCKED` | `127` |
| `frontend` | `Frontend build` | `BLOCKED` | `127` |
