...
- تاريخ التوليد: `2026-04-11T23:27:35.230547+00:00`
- الحالة العامة: `PASS`
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"transfer_id": 189, "accepted_qty": "50.000", "returned_qty": "10.000", "final_status": "partially_consumed", "custody_balance": "0.000", "top_up_blocked": true}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 868, "activity_id": 883, "variance_status": "OK", "cost_materials": "47500.0000", "cost_wastage": "4750.0000", "cost_machinery": "6000.0000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 869, "activity_id": 884, "tree_delta": -4, "tree_loss_reason": "جفاف طبيعي", "current_tree_count": 420}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 870, "activity_id": 885, "coverage_rows": 2, "activity_locations": 2, "distribution_mode": "exception_weighted"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"sync_status": "synced", "conflict_status_code": 400, "dlq_count": 59}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"purchase_order_id": 221, "receipt_movement_id": "2386", "issue_movement_id": "2387", "remaining_qty": "180.000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"request_id": 96, "request_status": "DISBURSED", "settlement_id": 84, "settlement_status": "APPROVED"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"supplier_settlement_id": 91, "status": "PAID", "paid_amount": "47500.0000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"status": "posted", "asset_id": 32, "ledger_rows": 128}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"harvest_activity_id": 887, "harvest_lot_id": 104, "invoice_id": 91, "invoice_status": "draft"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"share_contract_id": 147, "rental_contract_id": 148, "touring_id": 84, "rent_status": "posted", "dashboard_rows": 2}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"approval_request_id": 106, "approval_status": "APPROVED", "stage_events": 7, "workbench_rows": 3, "final_required_role": "SECTOR_DIRECTOR"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"authoritative_archive_state": "hot", "quarantine_state": "quarantined", "financial_records": 192}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
