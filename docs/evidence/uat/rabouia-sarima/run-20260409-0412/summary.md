...
- تاريخ التوليد: `2026-04-09T11:13:20.960774+00:00`
- الحالة العامة: `PASS`
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"transfer_id": 17, "accepted_qty": "50.000", "returned_qty": "10.000", "final_status": "partially_consumed", "custody_balance": "0.000", "top_up_blocked": true}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 465, "activity_id": 524, "variance_status": "OK", "cost_materials": "47500.0000", "cost_wastage": "4750.0000", "cost_machinery": "6000.0000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 466, "activity_id": 525, "tree_delta": -4, "tree_loss_reason": "جفاف طبيعي", "current_tree_count": 420}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 467, "activity_id": 526, "coverage_rows": 2, "activity_locations": 2, "distribution_mode": "exception_weighted"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"sync_status": "synced", "conflict_status_code": 400, "dlq_count": 2}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"purchase_order_id": 48, "receipt_movement_id": "548", "issue_movement_id": "549", "remaining_qty": "180.000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"request_id": 39, "request_status": "DISBURSED", "settlement_id": 27, "settlement_status": "APPROVED"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"supplier_settlement_id": 34, "status": "PAID", "paid_amount": "47500.0000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"status": "posted", "asset_id": 32, "ledger_rows": 14}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"harvest_activity_id": 528, "harvest_lot_id": 47, "invoice_id": 34, "invoice_status": "draft"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"share_contract_id": 33, "rental_contract_id": 34, "touring_id": 27, "rent_status": "posted", "dashboard_rows": 2}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"approval_request_id": 49, "approval_status": "APPROVED", "stage_events": 7, "workbench_rows": 3, "final_required_role": "SECTOR_DIRECTOR"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"authoritative_archive_state": "hot", "quarantine_state": "quarantined", "financial_records": 21}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
