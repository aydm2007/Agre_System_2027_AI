...
- تاريخ التوليد: `2026-04-09T11:56:36.873840+00:00`
- الحالة العامة: `PASS`
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"transfer_id": 81, "accepted_qty": "50.000", "returned_qty": "10.000", "final_status": "partially_consumed", "custody_balance": "0.000", "top_up_blocked": true}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 614, "activity_id": 652, "variance_status": "OK", "cost_materials": "47500.0000", "cost_wastage": "4750.0000", "cost_machinery": "6000.0000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 615, "activity_id": 653, "tree_delta": -4, "tree_loss_reason": "جفاف طبيعي", "current_tree_count": 420}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"daily_log_id": 616, "activity_id": 654, "coverage_rows": 2, "activity_locations": 2, "distribution_mode": "exception_weighted"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"sync_status": "synced", "conflict_status_code": 400, "dlq_count": 23}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"purchase_order_id": 113, "receipt_movement_id": "1234", "issue_movement_id": "1235", "remaining_qty": "180.000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"request_id": 60, "request_status": "DISBURSED", "settlement_id": 48, "settlement_status": "APPROVED"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"supplier_settlement_id": 55, "status": "PAID", "paid_amount": "47500.0000"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"status": "posted", "asset_id": 32, "ledger_rows": 56}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"harvest_activity_id": 656, "harvest_lot_id": 68, "invoice_id": 55, "invoice_status": "draft"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"share_contract_id": 75, "rental_contract_id": 76, "touring_id": 48, "rent_status": "posted", "dashboard_rows": 2}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"approval_request_id": 70, "approval_status": "APPROVED", "stage_events": 7, "workbench_rows": 3, "final_required_role": "SECTOR_DIRECTOR"}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
...
- الإجراء المقترح: لا يوجد.
- النتيجة: `{"authoritative_archive_state": "hot", "quarantine_state": "quarantined", "financial_records": 84}`
- code anchor: ``
- test anchor: ``
- gate anchor: ``
- evidence anchor: ``
